...
func redneckify*(text: string): string =
  ...
  "wait a minute": "hold yo horses",
  "wait a moment": "hold yo horses",
  "wait a second": "hold yo horses",
  "flustered": "ruffled-feathered",
  "winter cap": "tobaggon",
  "oh no": "hell naw",
  "sunny and rainny": "devil beating his wife",
...
when isMainModule:
  echo "Type or paste text to translate to Redneck slang: "
  echo redneckify(readLineFromStdin())
